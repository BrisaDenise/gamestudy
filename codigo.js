...
function validarContacto()
{
	...
	var celular_ = parseInt(document.contacto_form.celular.value);




	//if(celular_.lenght == 0 || celular_.lenght > 10 || celular_.lenght < 10 )
	if(celular_.lenght != 10 || inNaN(celular_))
	{
		//......
	}
